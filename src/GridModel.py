...
class LatticeModel: 
    """
    Base class for a PartialDiefferentialEquation on a d-dimensional lattice. 
    """
    ...
    def Defaul_callback(self, field, par, t): 
        ...
        """
        return jax.tree.map( lambda x : self.return_real(x) , field) 
